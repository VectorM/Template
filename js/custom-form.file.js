...
customForm.addModule({
	...
	defaultOptions: {
		...
		uploadStructure:'<div class="customForm-input-wrapper"><div class="customForm-wrap"></div><a class="customForm-upload-button"><span></span></a><label class="customForm-fake-input"><span><em></em></span></label></div>',
